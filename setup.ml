...
(* OASIS_START *)
(* DO NOT EDIT (digest: de276b9f4cf42714fba19f6642b2502a) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "lwt_parallel"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "±®\019WºÀ]§# \015âök\029a";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
