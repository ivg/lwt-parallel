...
(* OASIS_START *)
(* DO NOT EDIT (digest: d1d789ea78796c2ab62ac08dfb339385) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "parallel"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\152\190 k\185\134\198Q\217p\250\184ji\147\215";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
